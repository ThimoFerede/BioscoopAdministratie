...
namespace Films
{
    public class Bioscoopvertoning : Film
    {
        ...
        public Bioscoopvertoning(string titel, int jaar, int speelduur, string taal, int leeftijdscategorie, List<Genre> lijstGenres, DateTime begintijd, DateTime eindtijd,Filmkwaliteit filmkwaliteit, Zaal zaal) : base(titel, jaar, speelduur, taal, leeftijdscategorie, lijstGenres)
        {
            Begintijd = begintijd;
            Eindtijd = eindtijd;
            BioscoopZaal = zaal;
